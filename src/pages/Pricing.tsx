        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="border-2 border-green-200">
              <CardHeader className="text-center">
                ...
                <p className="text-xs text-gray-500">50+ pages</p>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2">
                  <li className="flex items-center gap-2">
          ...
          <div className="mt-12 p-8 bg-blue-50 rounded-lg text-center">
            ...
            <p className="text-lg text-gray-600 mb-4">
              Get free doorstep delivery for orders above ₹900
            </p>
            <p className="text-sm text-gray-500">
              Powered by DROPEE - Standard delivery charges apply for orders below ₹900
            </p>
          </div>
        </div>
      </section>
